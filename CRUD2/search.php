        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    $authorName = "";
                ?>
                <p>Please enter the title of the book or the author of the book you want to search.</p>
                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                    <div class="form-group" style="display: flex;">
                        ...
                        <div style="padding-left: 40px">
                            ...
                            <input type="text" name="name" class="form-control" value="<?php echo $authorName; ?>">
                        </div>
                    </div>
                ...
                if($_SERVER["REQUEST_METHOD"] == "POST")  {
                    ...
                    if(!empty($title) || !empty($authorName)) {
                        $sql = "SELECT * FROM books  as b INNER JOIN authors as a on b.authorid = a.authorid WHERE  b.title LIKE '%{$title}%' OR a.name LIKE '%{$authorName}%'";
